...
execute_process(
        COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v2.12.1"
        WORKING_DIRECTORY "C:/Users/eduar/CLionProjects/pcc176_tpFinal/cmake-build-release/_deps/catch2-src"
...
elseif (show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
    ...
    get_hash_for_ref("v2.12.1" tag_sha error_msg)
...
elseif (show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
    ...
    set(fetch_required YES)
    set(checkout_name "origin/v2.12.1")
...
if (git_update_strategy STREQUAL "CHECKOUT")
    ...
    if (error_code)
        ...
        if (NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
            ...
            message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/eduar/CLionProjects/pcc176_tpFinal/cmake-build-release/_deps/catch2-src'."
...
if (need_stash)
    ...
    if (error_code)
        ...
        if (error_code)
            ...
            message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/eduar/CLionProjects/pcc176_tpFinal/cmake-build-release/_deps/catch2-src'."
                    "\nYou will have to resolve the conflicts manually")
        endif ()
    endif ()
endif ()
