...
template<class It>
void test() { ranges::reverse_iterator < It > {}; }
...
int main() {
    {
        ...
        static_assert(
                ranges::detail::bidirectional_cursor <
                ranges::detail::reverse_cursor < RandomAccessIterator <
        const char *>>>,
        "");
        static_assert(
        ...
        static_assert(
                ...
                ranges::reverse_iterator < BidirectionalIterator <
        const char *>>>,
        "");
        static_assert(
                ranges::random_access_iterator <
                ranges::reverse_iterator < RandomAccessIterator <
        const char *>>>,
        "");
    }
    { // test
