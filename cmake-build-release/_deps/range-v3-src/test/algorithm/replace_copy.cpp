...
void test_iter() {
    ...
    int ib[sa] = {0};
    ranges::replace_copy_result <InIter, OutIter> r = ranges::replace_copy(InIter(ia), Sent(ia + sa), OutIter(ib), 2,
                                                                           5);
...
int main() {
    ...
    // Test projection
    {
        ...
        ranges::replace_copy_result < P * ,
                P * > r = ranges::replace_copy(in, out, 2, P{5, "5"}, &std::pair<int, std::string>::first);
