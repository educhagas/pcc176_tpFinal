...
constexpr /*c++14*/ auto test_it_back(It, It, Concept)
...
template<typename It>
constexpr /*c++14*/ auto test_it_(It beg, It last)
...
if (!
test_it_back(beg, last, ranges::iterator_tag_of<It>{}
)) {
return false; }
auto end2 = beg;
...
return false; }
if (
ranges::iter_enumerate(beg, last
) != std::pair<std::ptrdiff_t, It>{
4, last})
{
return false;
}
if (
ranges::iter_distance(beg, last
) != 4) {
return false; }
if (
ranges::iter_distance_compare(beg, last,
4) != 0) {
return false; }
if (
ranges::iter_distance_compare(beg, last,
...
template<typename It>
constexpr /*c++14*/ auto test_rit_(It beg, It last)
...
constexpr /*c++14*/ auto test_it(Sequence1234 &&a)
...
constexpr /*c++14*/ auto test_its_c(Sequence1234 &&a)

-> bool
{
return
test_it<InputIterator<int const *>>(a)
&&
...
template<typename Sequence1234>
constexpr /*c++14*/ auto test_its(Sequence1234 &&a)

-> bool
{
return
test_it<InputIterator<int *>>(a)
&&
...
template<typename It, typename Sequence1234>
constexpr /*c++14*/ auto test_rit(Sequence1234 &&a)
...
template<typename Sequence1234>
constexpr /*c++14*/ auto test_rits(Sequence1234 &&a)

-> bool
{
using rit =
decltype(ranges::rbegin(a)
);
return
...
template<typename It, typename Sequence1234>
constexpr /*c++14*/ auto test_cit(Sequence1234 &&a)
...
template<typename Sequence1234>
constexpr /*c++14*/ auto test_cits(Sequence1234 &&a)

-> bool
{
return
test_cit<InputIterator<int const *>>(a)
&&
...
template<typename It, typename Sequence1234>
constexpr /*c++14*/ auto test_crit(Sequence1234 &&a)
...
template<typename Sequence1234>
constexpr /*c++14*/ auto test_crits(Sequence1234 &&a)

-> bool
{
using rit =
decltype(ranges::crbegin(a)
);
return
test_crit<BidirectionalIterator<rit>>(a)
&&
test_crit<RandomAccessIterator<rit>>(a);
}

template<typename Sequence1234>
constexpr /*c++14*/ auto test_non_member_f(Sequence1234 &&a)
...
constexpr /*c++14*/ auto test_array()
...
if (a[0] != 5 || b[0] != 1 || a[3] != 8 || b[3] != 4) {
return false; }

return true;
}

constexpr /*c++14*/ auto test_c_array()
...
constexpr /*c++14*/ auto test_init_list()
