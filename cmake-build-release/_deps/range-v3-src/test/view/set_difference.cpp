...
int main() {
    ...
    // difference between two finite ranges/sets
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::finite,
                      "Cardinality of difference between two finite ranges should be finite!");
    ...
    // difference between two infinite ranges
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::unknown,
                      "Cardinality of difference of infinite ranges should be unknown!");
    ...
    // difference between a finite and an infinite range
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::finite,
                      "Cardinality of difference between a finite range and any other range should be finite!");
    ...
    // difference between an infinite and a finite range
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::infinite,
                      "Cardinality of difference between an infinite and finite range should be infinite!");
    ...
    // differences involving unknown cardinalities
    {
        ...
        static_assert(range_cardinality<decltype(res1)>::value == ranges::finite,
                      "Difference between a finite and unknown cardinality set should have finite cardinality!");

        auto res2 = views::set_difference(rng0, i2_finite);
        static_assert(range_cardinality<decltype(res2)>::value == ranges::unknown,
                      "Difference between an unknown cardinality and finite set should have unknown cardinality!");
        ...
        static_assert(range_cardinality<decltype(res4)>::value == ranges::unknown,
                      "Difference between an unknown and infinite cardinality set should have unknown cardinality!");
