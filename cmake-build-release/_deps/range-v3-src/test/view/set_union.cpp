...
int main() {
    ...
    // union of two finite ranges/sets
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::finite,
                      "Cardinality of union of finite ranges should be finite!");
    ...
    // union of two infinite ranges
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::infinite,
                      "Cardinality of union of infinite ranges should be infinite!");
    ...
    // union of a finite and an infinite range
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::infinite,
                      "Cardinality of union with an infinite range should be infinite!");
    ...
    // unions involving unknown cardinalities
    {
        ...
        static_assert(range_cardinality<decltype(res1)>::value == ranges::unknown,
                      "Union of a finite and unknown cardinality set should have unknown cardinality!");

        auto res2 = views::set_union(rng0, i2_finite);
        static_assert(range_cardinality<decltype(res2)>::value == ranges::unknown,
                      "Union of an unknown and finite cardinality set should have unknown cardinality!");

        auto res3 = views::set_union(i1_infinite, rng0);
        static_assert(range_cardinality<decltype(res3)>::value == ranges::infinite,
                      "Union of an infinite and unknown cardinality set should have infinite cardinality!");

        auto res4 = views::set_union(rng0, i1_infinite);
        static_assert(range_cardinality<decltype(res4)>::value == ranges::infinite,
                      "Union of an unknown and infinite cardinality set should have infinite cardinality!");

        auto res5 = views::set_union(rng0, rng0);
        static_assert(range_cardinality<decltype(res5)>::value == ranges::unknown,
                      "Union of two unknown cardinality sets should have unknown cardinality!");
    ...
    // projections
    {
        ...
        ::check_equal(res2,
                      {B{-20}, B{-10}, B{-2}, B{-1}, B{0}, B{1}, B{2}, B{3}, B{3}, B{4}, B{5}, B{6}, B{7}, B{8}, B{9},
                       B{20}});
    }
