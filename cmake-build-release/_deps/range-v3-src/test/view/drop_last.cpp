...
template<class Rng>
view_non_const_only<views::all_t < Rng>>
non_const_only(Rng
&&rng)
{
return view_non_const_only<views::all_t < Rng>>{
...
void random_acccess_test() {
    ...
    static_assert(
            ranges::random_access_range < Src > , "Must be exactly RA.");
    static_assert(
            std::is_same <
...
void bidirectional_test() {
    ...
    static_assert(
            ...
            ranges::bidirectional_range < Src > , "Must be exactly bidirectional.");
    static_assert(
            std::is_same <
...
void forward_test() {
    ...
    static_assert(
            ...
            ranges::forward_range < Src > , "Must be exactly forward.");
    static_assert(
            std::is_same <
            drop_last_view < views::all_t < Src & >> ,
...
void sized_test() {
    ...
    static_assert(
            ...
            ranges::input_range < Src > , "Must be exactly input.");

    static_assert(
            std::is_same <
            drop_last_view < views::all_t < Src >> ,
            drop_last_view < views::all_t < Src > , detail::drop_last_view::mode_sized >
                                                    > ::value, "Must have correct view.");
