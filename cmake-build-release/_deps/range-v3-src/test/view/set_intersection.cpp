...
int main() {
    ...
    // intersection of two finite ranges
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::finite,
                      "Cardinality of intersection with a finite range should be finite!");
    ...
    // intersection of two infinite ranges
    {
        ...
        static_assert(range_cardinality<R>::value == ranges::unknown,
                      "Cardinality of intersection of infinite ranges should be unknown!");
    ...
    // intersection of a finite and infinite range
    {
        ...
        static_assert(range_cardinality<decltype(res2)>::value == ranges::finite,
                      "Cardinality of intersection with a finite range should be finite!");
    ...
    // intersection of a set of unknown cardinality
    {
        ...
        static_assert(range_cardinality<decltype(res)>::value == ranges::unknown,
                      "Intersection with a set of unknown cardinality should have unknown cardinality!");
    }
