...
namespace ranges {
    ...
    private:
        ...
        private:
            ...
            sentinel_t <constify_if<meta::back < meta::list < Rngs...>>>>
            end_;
        ...
        private:
            ...
            using concat_view_t = constify_if<concat_view>;
            concat_view_t *rng_;
            variant<iterator_t < constify_if<Rngs>>...>
            its_;
        ...
        common_range<Rngs const>...>, //
        cursor<true>, //
        sentinel<true>>)(
        /// \pre
        requires and_v<range
        <Rngs const>...>)
        {
            return {this, end_tag{}};
        }
    ...
    public:
        ...
        CPP_ret (std::size_t)(
                /// \pre
                requires (detail::concat_cardinality<Rngs...>::value
        ...
        auto CPP_fun(size)()(
                const requires(detail

        ::concat_cardinality<Rngs...>::value < 0) &&
