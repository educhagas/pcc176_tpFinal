...
namespace ranges {
    ...
    private:
        ...
        private:
            ...
            std::tuple<iterator_t < constify_if<Views>>...>
            its_;
        ...
        public:
            ...
            explicit cursor(begin_tag, constify_if<cartesian_product_view> *view)
                    : view_(view), its_(tuple_transform(view->views_, ranges::begin)) {
            ...
            explicit cursor(end_tag, constify_if<cartesian_product_view> *view)
                    ...
                    end_tag{}, view,
                    meta::bool_ <
                    common_range < meta::at_c < meta::list < constify_if<Views>...
            ...
            cursor(cursor<Other> that)
                    : view_(that.view_), its_(std::move(that.its_)) {}

            common_tuple<range_reference_t < constify_if<Views>>...>
            ...
            CPP_ret(void)(
                    /// \pre
                    requires cartesian_produce_view_can_bidi
            ...
            CPP_ret(void)(
                    /// \pre
                    requires cartesian_produce_view_can_random
        ...
        CPP_ret (cursor<true>)(
                /// \pre
                requires cartesian_produce_view_can_const
        ...
        !cartesian_produce_view_can_bidi<std::true_type, Views...>))
        {
            return {};
        }
    ...
    namespace views {
        struct cartesian_product_fn {
            constexpr empty_view<std::tuple<>>
