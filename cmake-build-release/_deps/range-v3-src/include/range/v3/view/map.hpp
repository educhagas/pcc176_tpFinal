...
namespace ranges {
    ...
    namespace detail {
        ...
        constexpr T
        &
        get_first_second_helper(T
        & t, std::true_type) noexcept {
        return
        t;
    }
...
bool enable_borrowed_range<keys_range_view < Rng>>
=
enable_borrowed_range<Rng>;
template<typename Rng>
RANGES_INLINE_VAR constexpr
bool enable_borrowed_range<values_view < Rng>>
=
enable_borrowed_range<Rng>;
