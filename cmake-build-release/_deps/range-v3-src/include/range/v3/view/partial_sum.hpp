...
namespace ranges {
    ...
    namespace detail {
        ...
        AND
                assignable_from<range_value_t < Rng>
    ...
    private:
        ...
        base_{};
        RANGES_NO_UNIQUE_ADDRESS semiregular_box_t<Fun>
        fun_;
        ...
        private:
            ...
            RANGES_NO_UNIQUE_ADDRESS iterator_t<Base>
            current_{};
            RANGES_NO_UNIQUE_ADDRESS semiregular_box_t<range_value_t < Rng>>
            sum_;
        ...
        public:
            ...
            constexpr explicit cursor(Parent *rng)
                    : parent_{rng}, current_(ranges::begin(rng->base_)) {
            ...
            AND
                    convertible_to<iterator_t < Rng>
            const &,
            iterator_t <Base>>)

            constexpr cursor(cursor<Other> const &that)
                    : parent_{that.parent_}, current_(that.current_), sum_(that.sum_) {}
            ...
            bool CPP_fun(equal)(cursor const &that)(const //
    ...
    public:
        ...
        constexpr partial_sum_view(Rng rng, Fun fun)
