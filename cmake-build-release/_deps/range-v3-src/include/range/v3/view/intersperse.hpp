...
namespace ranges {
    ...
    private:
        ...
        public:
            ...
            cursor_adaptor(cursor_adaptor<Other> that)
                    : toggle_(that.toggle_), val_(std::move(that.val_)) {}

            template<typename View>
            constexpr iterator_t<CRng>
            begin(View
            & view)
            {
            ...
            auto equal(iterator_t<CRng> const &it0,
            ...
            auto distance_to(iterator_t<CRng> const &it,
        ...
        constexpr cursor_adaptor<false>
        ...
        !common_range <Rng>) || single_pass_iterator_ <iterator_t<Rng>>)
        {
            return {};
        }
        template(
        ...
        /// \pre
        requires Const
        AND range<meta::const_if_c < Const, Rng>>
        AND
        ...
        constexpr cursor_adaptor<Const>
        ...
        single_pass_iterator_ <iterator_t<meta::const_if_c < Const, Rng>>>)) //
        constexpr sentinel_adaptor<Const>
    ...
    bool enable_borrowed_range<intersperse_view<Rng>> = //
    ...
    namespace views {
        struct intersperse_base_fn {
            ...
            operator()(Rng &&rng, range_value_t<Rng>
            val) const
            {
