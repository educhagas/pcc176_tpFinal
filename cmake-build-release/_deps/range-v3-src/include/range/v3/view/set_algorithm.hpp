    ...
    namespace detail {
        ...
        public:
            ...
            set_algorithm_view(Rng1 rng1, Rng2 rng2, C pred, P1 proj1, P2 proj2)
                    : pred_(std::move(pred)), proj1_(std::move(proj1)), proj2_(std::move(proj2)),
                      rng1_(std::move(rng1)), rng2_(std::move(rng2)) {}
        };
        ...
        public:
            ...
            set_difference_cursor(pred_ref_ pred, proj1_ref_ proj1, proj2_ref_ proj2,
                    ...
                    : pred_(std::move(pred)), proj1_(std::move(proj1)), proj2_(std::move(proj2)), it1_(std::move(it1)),
                      end1_(std::move(end1)), it2_(std::move(it2)), end2_(std::move(end2)) {
                satisfy();
            }
            ...
            set_difference_cursor(
                    ...
                    : pred_(std::move(that.pred_)), proj1_(std::move(that.proj1_)), proj2_(std::move(that.proj2_)),
                      it1_(std::move(that.it1_)), end1_(std::move(that.end1_)), it2_(std::move(that.it2_)),
        ...
        constexpr cardinality
        set_difference_cardinality(cardinality
        c1,
        cardinality c2
        ) {
        return (c1 == unknown)
...
namespace detail {
    ...
    constexpr cardinality
    set_intersection_cardinality(cardinality
    c1,
    cardinality c2
    ) {
...
namespace detail {
    ...
    public:
        ...
        *it1_) &&
        ...
        noexcept (noexcept(iter_move(it1_)) &&

        noexcept (iter_move(it2_))
    ...
    constexpr cardinality
    set_union_cardinality(cardinality
    c1,
    cardinality c2
    ) {
...
namespace views {
    ...
    public:
        ...
        AND input_range<Rng2>
        AND
                common_with<range_value_t < Rng1>, range_value_t<Rng2>>
        AND
...
namespace detail {
    ...
    public:
        ...
        set_symmetric_difference_cursor(pred_ref_ pred, proj1_ref_ proj1,
                                        ...
                                        sentinel_t <R2> end2)
                : pred_(std::move(pred)), proj1_(std::move(proj1)), proj2_(std::move(proj2)), it1_(std::move(it1)),
                  end1_(std::move(end1)), it2_(std::move(it2)), end2_(std::move(end2)), state() {
            satisfy();
        }
    ...
    constexpr cardinality
    set_symmetric_difference_cardinality(cardinality
    c1,
    cardinality c2
    ) {
    return (c1 == unknown) || (c2 == unknown)
