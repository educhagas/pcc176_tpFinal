    ...
    ) //
{
    ...
    return false;
    if(!
    invoke(pred, invoke(proj1, *begin1), invoke(proj2, *begin2)
    ))
    ++
    begin2;
}
...
set_union_result<I1, I2, O> RANGES_FUNC(set_union)
(
I1 begin1,
        S1
end1,
...
O RANGES_FUNC(set_intersection)
(
I1 begin1,
        S1
end1,
...
set_difference_result<I1, O> RANGES_FUNC(set_difference)
(
I1 begin1,
        S1
end1,
...
RANGES_FUNC(set_symmetric_difference)
(
I1 begin1,
        S1
end1,
