...
namespace ranges {
    ...
    template(typename I, typename S, typename C, typename T,
    typename P = identity
    )(
    /// \pre
...
/// \overload
template(typename Rng, typename C, typename T,
typename P = identity
)(
/// \pre
...
>>
AND
        indirectly_writable<iterator_t < Rng>, T
const &>)
