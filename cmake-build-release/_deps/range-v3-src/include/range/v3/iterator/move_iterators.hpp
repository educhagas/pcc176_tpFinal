...
namespace ranges {
    ...
    struct make_move_sentinel_fn {
        ...
        AND (!input_iterator <S>)) //
        constexpr move_sentinel<S>
    ...
    namespace detail {
        ...
        private:
            ...
            *
            ...
            const)(
            /// \pre
            requires same_as<I const, II>
            AND indirectly_readable<II>
            )
            constexpr iter_rvalue_reference_t<II>
    ...
    struct move_into_fn {
        template<typename I>
        constexpr move_into_iterator<I>
