...
namespace ranges {
    ...
    namespace _iter_move_ {
        ...
        template<typename T>
        decltype(iter_move(std::declval<T>())
        )
        ...
        bool is_adl_indirectly_movable_v =
    ...
    template<typename I, typename O>
    RANGES_INLINE_VAR constexpr
    bool is_indirectly_movable_v =
            decltype(detail::is_indirectly_movable_<I, O>(nullptr, nullptr))
    ::value;

    template<typename I, typename O>
    RANGES_INLINE_VAR constexpr
    bool is_nothrow_indirectly_movable_v =
            decltype(detail::is_nothrow_indirectly_movable_<I, O>(nullptr))
    ::value;
...
namespace _iter_swap_ {
    ...
    template<typename T, typename U>
    RANGES_INLINE_VAR constexpr
    bool is_adl_indirectly_swappable_v =
    ...
    struct fn {
        ...
        const noexcept (noexcept(iter_swap((T &&) t,(U &&)
        ...
        noexcept (noexcept(ranges::swap(*a,
        ...
        *b)))
        ...
        constexpr detail::enable_if_t<
                !is_adl_indirectly_swappable_v < I0, I1>
        &&
        !is_swappable_with<iter_reference_t < I0>, iter_reference_t <I1>>::
        value &&
...
template<typename T, typename U>
RANGES_INLINE_VAR constexpr
bool is_indirectly_swappable_v =
        decltype(detail::is_indirectly_swappable_<T, U>(nullptr, nullptr))
::value;

template<typename T, typename U>
RANGES_INLINE_VAR constexpr
bool is_nothrow_indirectly_swappable_v =
        decltype(detail::is_nothrow_indirectly_swappable_<T, U>(0))
::value;
