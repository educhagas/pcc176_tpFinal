...
namespace ranges {
    ...
    // ) &&
    same_as<iter_reference_t
    <I const>, iter_reference_t <I>>
    AND
            same_as<iter_rvalue_reference_t
    <I const>, iter_rvalue_reference_t <I>>
    AND
    ...
    *
    ...
    s - i,
    i - s,
    concepts::requires_<same_as < iter_difference_t < I>,
    decltype(s
    - i)>>,
    concepts::requires_<same_as < iter_difference_t < I>,
    decltype(i
    ...
    *o++ = (T &&) t
    ...
    AND
            ...
            invoke_result_t < F & , iter_value_t < I1>
    &, iter_value_t <I2> &>,
    ...
    concept (indirectly_regular_binary_invocable_impl_)(F, I1, I2),
            regular_invocable<F &, iter_value_t < I1>
    ...
    concept (indirect_strict_weak_order_)(F, I1, I2),
            strict_weak_order<F &, iter_value_t < I1>
    ...
    AND
            assignable_from<iter_value_t < I>
    &, iter_rvalue_reference_t <I>>
    );
...
RANGES_DEPRECATED("Please switch to indirect_result_t")
=
