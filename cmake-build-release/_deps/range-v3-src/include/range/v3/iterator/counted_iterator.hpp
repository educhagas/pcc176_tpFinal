...
constexpr counted_iterator(counted_iterator < I2 >
const & i)
:
...
post_increment_ (std::is_void<decltype(current_++)>());
...
constexpr bool operator==(counted_iterator < I1 >
const & x,
counted_iterator <I2> const &y
)
{
...
template<typename I>
constexpr bool operator==(counted_iterator < I >
...
template<typename I>
constexpr bool operator==(default_sentinel_t, counted_iterator < I >
const & x)
{
return x.
