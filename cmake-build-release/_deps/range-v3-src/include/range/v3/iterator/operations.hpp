...
namespace ranges {
    ...
    struct prev_fn {
        ...
        operator()(I it, iter_difference_t <I> n, I bound) const {
    ...
    public:
        ...
        constexpr std::pair<iter_difference_t < I>, I
        >
...
private:
    ...
    template<typename Rng>
    static constexpr range_difference_t<Rng>
    impl_r(Rng
    & rng, sized_range_tag)
    {
...
public:
    ...
    constexpr range_difference_t<Rng>
