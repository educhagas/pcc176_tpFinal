...
namespace ranges {
    ...
    namespace detail {
        ...
        private:
            ...
            static constexpr diffmax_t

            _normalize(bool neg, std::uintmax_t val) {
        ...
        public:
            ...
            constexpr diffmax_t(T val)

            noexcept
                    : neg_(0 > val)
            , val_(
            0 > val ? static_cast<std::uintmax_t>(-val)
            : static_cast
            <std::uintmax_t>(val)
            )
            {}

            friend constexpr bool operator<(diffmax_t a, diffmax_t b)
            ...
            template<typename T>
            friend constexpr auto operator+=(T &a, diffmax_t b)
...
namespace std {
    ...
    struct numeric_limits<::ranges::detail::diffmax_t> {
        ...
        static constexpr::ranges::detail::diffmax_t max()
        ...
        static constexpr::ranges::detail::diffmax_t min()
        ...
        static constexpr::ranges::detail::diffmax_t lowest()
        ...
        static constexpr::ranges::detail::diffmax_t epsilon()
        ...
        static constexpr::ranges::detail::diffmax_t round_error()
        ...
        static constexpr::ranges::detail::diffmax_t infinity()
        ...
        static constexpr::ranges::detail::diffmax_t quiet_NaN()
        ...
        static constexpr::ranges::detail::diffmax_t signaling_NaN()
        ...
        static constexpr::ranges::detail::diffmax_t denorm_min()
