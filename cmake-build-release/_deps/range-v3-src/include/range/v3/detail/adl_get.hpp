...
namespace ranges {
    ...
    namespace detail {
        namespace _adl_get_ {
            ...
            constexpr auto adl_get(TupleLike &&t)
...
namespace _tuple_wrapper_ {
    ...
    struct forward_tuple_interface : TupleLike {
        ...
        CPP_ctor (forward_tuple_interface)(TupleLike &&base)(    //
        ...
        static_cast<TupleLike &&>(base))
        {}
        CPP_member
                constexpr

        CPP_ctor (forward_tuple_interface)(TupleLike const &base)( //
