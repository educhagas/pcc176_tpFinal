...
namespace ranges {
    ...
    private:
        ...
        constexpr semiregular_box(tag, std::false_type)

        noexcept
        {}

        constexpr semiregular_box(tag, std::true_type)
    ...
    public:
        ...
        semiregular_box(semiregular_box &&that)
        ...
        semiregular_box(semiregular_box const &that)
        ...
        template(typename U)(
        /// \pre
        requires (!same_as <uncvref_t<U>, semiregular_box>)
        AND
                constructible_from<T, U>
        ...
        semiregular_box &operator=(semiregular_box &&that)
        ...
        semiregular_box &operator=(semiregular_box const &that)
    ...
    struct semiregular_box<T &>
            : private ranges::reference_wrapper<T &>, private detail::semiregular_get {
        ...
        semiregular_box(in_place_t, Arg &arg)
