...
return static_cast<any::impl<detail::decay_t < T>> *>(x.ptr_.
...
return static_cast<any::impl<detail::decay_t < T>> const *>(x.ptr_.
...
->ptr_)
if(
any::impl <T> *q = dynamic_cast<any::impl <T> *>(p->ptr_.get())
)
return &q->
...
->ptr_)
if(
any::impl <T> const *q = dynamic_cast<any::impl <T> const *>(p->ptr_.get())
)
return &q->
