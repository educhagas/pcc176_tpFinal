...
namespace ranges {
    ...
    public:
        ...
        constexpr overloaded(First first, Rest... rest)
                : first_(static_cast<First &&>(first)), second_{static_cast<Rest &&>(rest)...} {}

        template(typename... Args)(
        /// \pre
        requires invocable<First, Args...>
        )
        constexpr _result_t<detail::_id, Args...>
        ...
        constexpr _result_t<detail::_ref, Args...>
        ...
        constexpr _result_t<detail::_cref, Args...>
