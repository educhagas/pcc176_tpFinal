...
namespace ranges {
    ...
    AND
            ...
            composed < coerce < iter_value_t < I>>
    , BOp>,
    iter_value_t <I>*, I>
    );
    template<typename I, typename BOp>
    ...
    struct partial_sum_fn {
        ...
        /// \pre
        requires sentinel_for<S1, I>
        AND sentinel_for<S2, O>
        AND
        ...
        AND partial_sum_constraints<I, O, BOp, P>
        )
        ...
        template(typename Rng, typename ORef,
        typename BOp = plus,
        typename P = identity,
        ...
        template(typename Rng, typename ORng,
        typename BOp = plus,
        typename P = identity,
        typename I = iterator_t < Rng >,
