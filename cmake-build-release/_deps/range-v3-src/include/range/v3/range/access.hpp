...
namespace ranges {
    ...
    namespace detail {
        ...
        bool _borrowed_range =
                enable_borrowed_range < uncvref_t < T >>;

        template<typename T>
        RANGES_INLINE_VAR constexpr
        bool _borrowed_range<T &> = true;
    } // namespace detail
    ...
    namespace _begin_ {
        ...
        public:
            ...
            *
            ...
            template(typename R)(
            /// \pre
            requires detail::_borrowed_range<R>
            AND
            (has_member_begin<R>
    ...
    namespace _cbegin_ {
        struct fn {
            template<typename R>
            constexpr _begin_::_t<detail::as_const_t<R>>
    ...
    namespace _cend_ {
        struct fn {
            template<typename R>
            constexpr _end_::_t<detail::as_const_t<R>>
    ...
    namespace _rbegin_ {
        ...
        template<typename T>
        void rbegin(std::initializer_list < T > )
        = delete;
    ...
    namespace _rend_ {
        ...
        // and returning a std::reverse_iterator.
        template<typename T>
        void rend(std::initializer_list < T > )
        = delete;
    ...
    namespace _crbegin_ {
        struct fn {
            template<typename R>
            constexpr _rbegin_::_t<detail::as_const_t<R>>
    ...
    namespace _crend_ {
        struct fn {
            template<typename R>
            constexpr _rend_::_t<detail::as_const_t<R>>
    ...
    using iterator_t =
    decltype(begin(std::declval<Rng &>())
    );
