    ...
    namespace detail {
        ...
        public:
            ...
            reference operator*() const {
                return to_container::fn<meta::id < ValueType>>
                {}
                (*it_);
            }
        ...
        struct from_range {
            ...
            decltype (from_range::from_rng_<Rng>(
...
/// \pre
requires range<Rng>
AND detail::convertible_to_cont<Rng, Cont>
)

auto to(Rng &&rng) -> Cont {
    return detail::to_container_fn<meta::id < Cont>>
    {}
    (static_cast<Rng &&>(rng));
}
...
bool
        is_pipeable_v<detail::to_container_closure < MetaFn, Fn>>
= true;
} // namespace ranges
