...
namespace meta {
    ...
    namespace detail {
        ...
        constexpr indices_strategy_
        strategy_(std::size_t
        cur,
        std::size_t end
        ) {
...
namespace detail {
    ...
    find_index_i_(bool const *const first, bool const *const last,
                  std::size_t N = 0) {
...
namespace detail {
    ...
    reverse_find_index_i_(bool const *const first,
...
namespace detail {
    ...
    count_i_(bool const *const begin, bool const *const end,
             std::size_t n) {
